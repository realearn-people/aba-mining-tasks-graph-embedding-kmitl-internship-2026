...
OUTPUT_DIR   = ROOT / "outputs" / "transe_sup_output"             # folder for saved outputs
...
if __name__ == "__main__":
    ...
    try:
        ...
        df_orig[['head','relation','tail','score','head_x','head_y','tail_x','tail_y']].to_csv(
            VIZ_FILE, index=False
        )
        print(f"Saved: {VIZ_FILE}  ({len(df_orig):,} triples)")

        # ══════════════════════════════════════════════════════════════════════════
        # xport ABA tree structure for Tree View
        # This is a separate file the visualizer uses to build the 8 trees
        # ══════════════════════════════════════════════════════════════════════════
