...
OUTPUT_DIR   = ROOT / "outputs" / "transe_output"             # folder for saved outputs
#OUTPUT_DIR   = Path("transe_pnnp_output") 
...
if __name__ == "__main__":
    ...
    # transe embeddings are complex — concatenate real + imaginary for PCA
    # ══════════════════════════════════════════════════════════════════════════════
    print("=" * 60)
